---
title: Building a Monitor Just For Spotify
tags: TeXt
---
...
![Spotify car thing]({{site.url}}/assets/images/2022-11-14-spotify-display/carthing.png)
...
![monitor with ports on the side]({{site.url}}/assets/images/2022-11-14-spotify-display/amazon-prebuilt-monitor.png)
...
![case in fusion 360]({{site.url}}/assets/images/2022-11-14-spotify-display/case-fusion-360.png)
...
![behind monitor]({{site.url}}/assets/images/2022-11-14-spotify-display/behind-monitor.jpg)
...
![insides]({{site.url}}/assets/images/2022-11-14-spotify-display/insides.jpg)
...
[Mini Player for Spotify](https://chrome.google.com/webstore/detail/mini-player-for-spotify/mjjeebakniihklfggnacbigighgildlo?hl=en) is an extension that adds some CSS to the Spotify player to get rid of the unnecessary stuff.
...
![interface]({{site.url}}/assets/images/2022-11-14-spotify-display/interface.jpg)
...
* Switching to [Thorium](https://thorium.rocks/) instead of Slimjet because it's open source
* Tapping the buttons works fine, but dragging the timebar doesn't. I haven't been able to find a reliable way to fix that, but it works fine on the mobile interface. The mobile interface is more difficult and time consuming to modify though.
* I could show my Home Assistant dashboard instead. That would let me easily control the lights in my room, but the Spotify HA plugin is unreliable so I'd have to fix that first.
